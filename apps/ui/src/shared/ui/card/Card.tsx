...
const colorClasses: Record<string, string> = {
  ...
  blue: "bg-[#d7e6f7] text-[#2f4a7c] shadow-[4px_4px_0_#a3b8c2] dark:bg-[#7a8cb8] dark:text-[#d7e6f7] dark:shadow-[4px_4px_0_#4f5c7a]",
  red: "bg-[#f7d7d7] text-[#7c2f2f] shadow-[4px_4px_0_#c2a3a3] dark:bg-[#b87a7a] dark:text-[#f7d7d7] dark:shadow-[4px_4px_0_#7a4f4f]",
};
