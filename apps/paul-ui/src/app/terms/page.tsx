export default function TermsPage() {
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <p className="mb-4">
        By using this application, you agree to the terms described below. This
        application uses the YouTube API to provide personalized features and
        relies on the data provided by this API.
      </p>
      <p className="mb-4">
        You authorize access to your YouTube account data only for the purpose
        of displaying and modifying information related to your own account, as
        requested by you. We do not use your data for any other purpose.
      </p>
      <p className="mb-4">
