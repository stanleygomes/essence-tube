...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Content
      ...
      className="w-full overflow-hidden rounded-b-base bg-secondary-background text-sm font-base transition-all data-[state=closed]:animate-accordion-up data-[state=open]:animate-accordion-down"
      {...props}
    >
